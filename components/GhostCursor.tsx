...
const GhostCursor: React.FC<GhostCursorProps> = ({
  className,
  style,
  trailLength = 35,       // slightly shorter trail
  inertia = 0.4,      // less glide = less smear

  grainIntensity = 0.02,   // ↓ much softer grain
  bloomStrength = 0.04,   // ↓ major glow reduction
  bloomRadius = 0.6,   // ↓ tighter bloom spread
  bloomThreshold = 0.06,  // ↑ fewer pixels bloom

  brightness = 0.02,    // ↓ MAIN brightness reduction
  color = '#B19EEF',      // unchanged (color is fine)
  mixBlendMode = 'screen',   // unchanged (still looks good)
